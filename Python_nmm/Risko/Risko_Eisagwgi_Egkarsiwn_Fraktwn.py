...
for j in range(6, 12):
    ...
    for i in range(N // 2):
        vima = (249 - 52) * fr / N * 2
        tankiP = [StartingPosition + i * vima, StartingPosition + (i + 1) * vima, 2, 20.8, B - dh, B / 2, C / N * 0.98]
        tankiS = [StartingPosition + i * vima, StartingPosition + (i + 1) * vima, 2, 20.8, B / 2, dh, C / N * 0.98]
        TankList.append(tankiP)
        TankList.append(tankiS)
