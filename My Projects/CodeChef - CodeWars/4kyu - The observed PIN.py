"""
Created on Mon 28 Nov 22:49 2022
Finished on
@author: Cpt.Ender
...
the observed one and also the results, must be strings, because of potentially leading 0s.
...
expectations = [('8', ['5','7','8','9','0']),
                ...
                ('369', ["339","366","399","658","636","258","268","669","668","266","369","398","256","296","259",
                "368","638","396","238","356","659","639","666","359","336","299","338","696","269","358","656",
                "698","699","298","236","239"])]
                                                                                             """

adjacent = {'1': ['1', '2', '4'], '2': ['2', '1', '3', '5'], '3': ['3', '2', '6'], '4': ['4', '1', '5', '7'],
            '5': ['5', '2', '4', '6', '8'], '6': ['6', '3', '5', '9'], '7': ['7', '4', '8'],
            '8': ['8', '5', '7', '9', '0'], '9': ['9', '6', '8'], '0': ['0', '8']}


def get_pins(observed: str, i=0):
    if i == len(observed):
        return ['']
    array = []

    for adj in adjacent[observed[i]]:
        observed = observed[0:i] + adj + observed[i + 1:len(observed)]
        array.append(observed)
        array += get_pins(observed, i + 1)[1:]
    return array
